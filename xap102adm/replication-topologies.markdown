...
{% refer %}For more details about the recovery process refer to [Space Instance Recovery](./space-instance-recovery.html){% endrefer %}
...
{% refer %}For more details about this topology refer to [Asynchronous Persistency with the Mirror]({%currentjavaurl%}/asynchronous-persistency-with-the-mirror.html){% endrefer %}
