...
{% refer %}See the [Memory Management Facilities]({%currentadmurl%}/memory-management-facilities.html) for details about the differences between `ALL_IN_CACHE` and the `LRU` cache policies.{% endrefer %}
